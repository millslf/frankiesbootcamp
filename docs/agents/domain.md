...
If any of these files don't exist, **proceed silently**. Don't flag their absence; don't suggest creating them upfront. The producer skills create them lazily when terms or decisions actually get resolved.

...
<head>
    ...
    <title>No active competition</title>
</head>
<body class="bg-light">
            ...
            <div class="card shadow-sm border-0">
                <div class="card-body p-4 p-md-5">
                    <div class="text-center mb-4">
                        <div class="display-5 text-primary mb-3"><i class="bi bi-clock-history"></i></div>
                        <h1 class="h3 mb-3">No active competition right now, <%= displayName %></h1>
                        <p class="text-muted mb-0">
                            You are not in a current active competition, but you do have previous competitions.
                        </p>
                    </div>
                    ...
                    <ul class="list-group mb-4">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-start">
                            ...
                            <a class="btn btn-sm btn-outline-primary" href="<%=pageContextPath%>/app/select-competition?competitionId=<%= competition.getId() %>">View outcome</a>
                        </li>
                        <% } %>
                    </ul>
